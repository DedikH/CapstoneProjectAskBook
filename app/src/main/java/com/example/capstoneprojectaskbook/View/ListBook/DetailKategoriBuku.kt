...
class DetailKategoriBuku : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val fiksibook = listOf("Laskar Pelangi", "Dilan 1990", "Promise", "Bumi Manusia",
            "Rumah kaca", "Koala Kumal", "Tentang Kamu", "5 cm", "Memahami Film", "Sangkuriang",
            "Student Hidjo", "Funiculi Funicula", "Pangeran Cilik: Le Petit Prince", "Man Boy",
            "Keajaiban Toko Kelontong Namiya", "Laut Bercerita", "Aroma Karsa", "Selamat Tinggal")
